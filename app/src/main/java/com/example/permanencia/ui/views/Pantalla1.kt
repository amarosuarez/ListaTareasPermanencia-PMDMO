package com.example.permanencia.ui.views
...
import com.example.permanencia.MainActivity.Companion.basedatos
...
@Composable
    ...
    fun pantalla(){
        ...
        LaunchedEffect(Unit) {
            // Código asíncrono que se ejecutará sólo una vez al cargar el coroutine
            listaTareas.clear()
